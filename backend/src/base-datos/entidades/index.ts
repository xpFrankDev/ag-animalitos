...
export * from './grupo-animales.entity';
...
export const entidades = [Usuario, Grupero, Agencia, Animal, GrupoAnimales, Sorteo, HorarioSorteo, Ticket, JugadaTicket, Resultado, ControlAcceso];
