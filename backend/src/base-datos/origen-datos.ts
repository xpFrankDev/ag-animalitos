...
export const origenDatos = new DataSource({
  ...
  entities: entidades,
  migrations: [CrearEsquemaInicial1710000000000, NormalizarCodigosAnimales1710000001000, CorregirAnimalesDuplicados1710000002000, ResultadosPorBanquero1710000003000],
  synchronize: false,
  logging: false,
});
