...
export function InicioSesionRuta({ alIngresar }: Propiedades) {
  ...
  return <section className="contenedor-acceso"><form className="tarjeta acceso" onSubmit={enviar}>
    <div className="ilustracion"><img src="/animalitos/ilustraciones/ballena-ticket.png" alt={t('ilustracion_acceso')} /><span>00</span></div><h1>{t('acceso_agencia')}</h1><p>{t('iniciar_descripcion')}</p>
